...
# comment if you need specific version from sources
RUN apk add nginx
...
RUN docker-php-source extract \
    ...
    && docker-php-ext-install -j"$(getconf _NPROCESSORS_ONLN)" bcmath exif gd gmp intl mysqli opcache pcntl pdo_mysql soap sockets xmlrpc xsl \
